...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2022 at 05:35 PM
...
(1, 4, '2021-12-31 10:57:19', 1, 'Người bán hàng quá đẹp trai và tốt bụng', 1),
(2, 4, '2021-12-31 11:01:42', 0, 'Mua hàng không trả tiền ??? Sống lỗi quá vậy :(', 2),
(4, 1, '2021-12-31 10:59:35', 1, 'Mua hàng và trả tiền siêu nhanh. Good +1', 1),
(4, 2, '2021-12-31 11:02:07', 0, 'Thích thì không trả đấy làm gì đươc nhau', 2);
...
ALTER TABLE `banned_bidder`
  ...
  ADD CONSTRAINT `banned_bidder_ibfk_2` FOREIGN KEY (`ProID`) REFERENCES `product` (`ProID`);
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `fk_cat_id` FOREIGN KEY (`CatID`) REFERENCES `category` (`CatID`) ON DELETE NO ACTION ON UPDATE CASCADE,
